    ...
    <div class="max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-lg mt-10 border border-gray-100">
        ...
        <form action="{{ route('admin.barang.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Harga -->
            <div>
                <label class="block text-gray-700 mb-2 font-semibold">Harga Sewa 1 Malam</label>
                <input type="number" name="harga_sewa" value="{{ old('harga_sewa') }}"
                    class="w-full border border-gray-300 rounded-xl px-4 py-2.5 shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-600 transition duration-200" required>
            </div>

            <div>
                <label class="block font-medium mb-2">Harga 2 Malam (Optional)</label>
                <input type="number" name="harga_2_malam" value="{{ old('harga_2_malam') }}"
            ...
            <div>
                <label class="block font-medium mb-2">Harga 3 Malam (Optional)</label>
                <input type="number" name="harga_3_malam" value="{{ old('harga_3_malam') }}"
                class="w-full border border-gray-300 rounded-xl px-4 py-2.5 shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-600 transition duration-200">
