            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <span class="text-sm text-gray-400 font-medium bg-gray-100 px-2 py-1 rounded-md" id="priceLabel">/ 1 Malam / 1 unit</span>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <div class="flex items-center border border-gray-200 rounded-xl shadow-sm bg-gray-50">
                                    ...
                                    <input type="number" name="kuantitas" id="kuantitas" value="1" min="1" max="{{ $barang->stok }}"
                                           class="w-full text-center font-bold text-gray-900 border-0 bg-transparent focus:ring-0" readonly onchange="updatePrice()">
                        ...
                        <div class="flex gap-3">
                            ...
                            @else
                                <button type="button" class="w-full bg-gray-100 text-gray-400 py-4 rounded-xl font-bold cursor-not-allowed border border-gray-200" disabled>
                                    <i class="fa-solid fa-lock mr-2"></i> Stok Habis ({{ $barang->stok }} unit)
                                </button>
                            @endif
                        </div>
                    </form>
